...
class qrapp():
    def __init__(self,debug=False):
        self.debug=debug
        self.encoded_image = base64.b64encode(open(r'qrclock\files\image.png', 'rb').read())               
        self.app = Dash(__name__)
        self.app.layout = html.Div([html.H1(children="QR-CLOCK",id="headline"),
